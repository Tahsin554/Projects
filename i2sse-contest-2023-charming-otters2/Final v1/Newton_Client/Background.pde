class Background {
  ...
  //pos appleX, pos appleY, color, size, velocitY
  ...
  void renderObject() {
    //fill is currently set to the integer "c" in an effort to call the object after it reaches the bottom of the screen
    //fill(c);
