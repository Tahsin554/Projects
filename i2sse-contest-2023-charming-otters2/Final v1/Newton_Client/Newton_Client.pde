...
Atm blinkingAtm = new Atm(550, 400);
Body newtonBody;
...
void draw() {
  ...
  //this object is then summoned to be executed with the function "render_object"
